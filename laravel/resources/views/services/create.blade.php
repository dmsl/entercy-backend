...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
  ...
  <p>For inquiries please contact us on <a href="mailto:entercyprus20@gmail.com">entercyprus20@gmail.com</a> <br>
  For more information about the EnterCY project and platform, please follow this <a href="https://www.entercyprus.com/" target="_blank">link</a>.</p>
  ...
  {!! Form::open(['action' => 'ServicesController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="form-group">
      {{Form::label('registered_service', 'Please select establishment/service *')}}
      <br>
      <select name="registeredservice_id" id="registeredservice_id" class="form-control select2" required>
