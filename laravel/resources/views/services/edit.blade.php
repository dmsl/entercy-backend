...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  ...
  {!! Form::open(['action' => ['ServicesController@update', $service->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    ...
    <!---<div class="form-group">
      ...
      {{Form::text('name', $service->name, ['class' => 'form-control', 'placeholder' => 'Name of establishment'] )}}
    </div>--->

    <div class="form-group">
      {{Form::label('email', 'E-mail Address *')}}
      {{Form::text('email', $service->email, ['class' => 'form-control', 'placeholder' => 'E-mail Address'] )}}
    </div>

    <div class="form-group">
      {{Form::label('telephone', 'Phone Number *')}}
      {{Form::text('telephone', $service->telephone, ['class' => 'form-control', 'placeholder' => 'Phone Number'] )}}
    </div>
    ...
    {{Form::label('address', 'Address ( Please press the button to check address/coordinates online ) *')}}
      <div class="row">
          <div class="col-md-9">
            {{Form::text('address', $service->address, ['class' => 'form-control', 'placeholder' => 'Address'] )}}
          </div>
          <div class="col-md-3">
    ...
    <div class="form-group coords ">
      ...
      <div class="row">
          <div class="col-md">
            ...
            {{Form::text('coord_lat', $service->coord_lat, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('coord_long', 'Longitude:')}}
            {{Form::text('coord_long', $service->coord_long, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div>
    </div>
    ...
    <div class="form-group imgs ">
     ...
     <div class="form-group">
      ...
      {{Form::textarea('description', $service->description, ['class' => 'form-control', 'rows'=>'3', 'placeholder' => 'Description in English'] )}}
    </div>

    <div class="form-group">
      {{Form::label('website', 'Website')}}
      {{Form::text('website', $service->website, ['class' => 'form-control', 'placeholder' => 'Website'] )}}
    </div>

    <div class="form-group">
      {{Form::label('servicecategory', 'Service Category *')}}
      <br>
      <select id="servicecategoryOption" onchange="val2()" class="browser-default custom-select form-control" name="service_category"  >
    ...
    <div class="form-group">
      ...
      {{Form::text('other_servicecategory', $service->other_servicecategory, ['class' => 'form-control', 'placeholder' => 'If "Other" Service Category selected, please specify'] )}}
    </div>
    ...
    <div class="form-group time ">
      ...
      <div class="row">
          <div class="col-md">
            ...
            {{Form::time('monday_start', $service->monday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('monday_end', 'Monday close time:')}}
            {{Form::time('monday_end', $service->monday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div><br>
      <div class="row">
          <div class="col-md">
            {{Form::label('tuesday_start', 'Tuesday open time:')}}
            {{Form::time('tuesday_start', $service->tuesday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('tuesday_end', 'Tuesday close time:')}}
            {{Form::time('tuesday_end', $service->tuesday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div><br>
      <div class="row">
          <div class="col-md">
            {{Form::label('wednesday_start', 'Wednesday open time:')}}
            {{Form::time('wednesday_start', $service->wednesday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('wednesday_end', 'Wednesday close time:')}}
            {{Form::time('wednesday_end', $service->wednesday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
    </div><br>
    <div class="row">
          <div class="col-md">
            {{Form::label('thursday_start', 'Thursday open time:')}}
            {{Form::time('thursday_start', $service->thursday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('thurday_end', 'Thursday close time:')}}
            {{Form::time('thursday_end', $service->thursday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div><br>
    <div class="row">
          <div class="col-md">
            {{Form::label('friday_start', 'Friday open time:')}}
            {{Form::time('friday_start', $service->friday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('friday_end', 'Friday close time:')}}
            {{Form::time('friday_end', $service->friday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div><br>
    <div class="row">
          <div class="col-md">
            {{Form::label('saturday_start', 'Saturday open time:')}}
            {{Form::time('saturday_start', $service->saturday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('saturday_end', 'Saturday close time:')}}
            {{Form::time('saturday_end', $service->saturday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div><br>
    <div class="row">
          <div class="col-md">
            {{Form::label('sunday_start', 'Sunday open time:')}}
            {{Form::time('sunday_start', $service->sunday_start, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
          <div class="col-md">
            {{Form::label('sunday_end', 'Sunday close time:')}}
            {{Form::time('sunday_end', $service->sunday_end, ['class' => 'form-control', 'placeholder' => ''] )}}
          </div>
      </div>
    </div>
    ...
    <div class="form-group other_cusine_type">
      ...
      {{Form::text('other_cusine_type', $service->other_cuisine_type, ['class' => 'form-control', 'placeholder' => 'If "Other" cuisine type selected, please specify'] )}}
    </div>
...
<script>
    ...
    document.getElementById('monthclosed_from').value = '{{$service->month_closed_from}}'; //preselect type option
    document.getElementById('monthclosed_to').value = '{{$service->month_closed_to}}'; //preselect type option
    document.getElementById('premisesOption').value = '{{$service->premises}}'; //preselect type option
    document.getElementById('cuisine_type1').value = '{{$service->cuisine_type1}}'; //preselect type option
    document.getElementById('cuisine_type2').value = '{{$service->cuisine_type2}}'; //preselect type option
    document.getElementById('cuisine_type3').value = '{{$service->cuisine_type3}}'; //preselect type option
    document.getElementById('cuisine_type4').value = '{{$service->cuisine_type4}}'; //preselect type option
    document.getElementById('cuisine_type5').value = '{{$service->cuisine_type5}}'; //preselect type option
    document.getElementById('dietary_restr1').value = '{{$service->dietary_restr1}}'; //preselect type option
    document.getElementById('dietary_restr2').value = '{{$service->dietary_restr2}}'; //preselect type option
    document.getElementById('dietary_restr3').value = '{{$service->dietary_restr3}}'; //preselect type option
    document.getElementById('price').value = '{{$service->price}}'; //preselect type option
    document.getElementById('hotel_class').value = '{{$service->hotel_class}}'; //preselect type option
    val2();
  	});
